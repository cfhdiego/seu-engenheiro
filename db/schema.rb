...
ActiveRecord::Schema.define(version: 20160712233241) do
  ...
  create_table "colaboradores_grupo_demandas", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
