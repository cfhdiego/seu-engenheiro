class ColaboradoresController < ApplicationController
  ...
  private
    ...
    def colaborador_params
      params.require(:colaborador).permit(:pessoa_id, :tipo_colaborador_id, :habilitado, pessoa_attributes: [:id, :nome, :cpf, :rg, :data_nascimento, :email, :telefone, :celular, endereco_attributes: [:id, :cidade_id, :logradouro, :complemento, :cep, :numero]], pessoa_attributes: [:id, :nome, :cpf, :rg, :data_nascimento, :email, :telefone, :celular, endereco_attributes: [:id, :cidade_id, :logradouro, :complemento, :cep, :numero]])
    end
end
